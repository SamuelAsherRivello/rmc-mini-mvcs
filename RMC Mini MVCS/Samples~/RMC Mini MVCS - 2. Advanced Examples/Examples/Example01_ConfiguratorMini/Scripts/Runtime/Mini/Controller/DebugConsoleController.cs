...
namespace RMC.MiniMvcs.Samples.Configurator.Mini.Controller
{
    ...
    /// </summary>
    public class DebugConsoleController: BaseController // Extending 'base' is optional
        <ConfiguratorModel, DebugConsoleView, ConfiguratorService> 
    {
        public DebugConsoleController(
            ConfiguratorModel model, DebugConsoleView view, ConfiguratorService service) 
