using System;
using RMC.Mini.Samples.SpawnerMini.WithMini.Mini.Controller;
using RMC.Mini.Samples.SpawnerMini.WithMini.Mini.Model;
...
namespace RMC.Mini.Samples.SpawnerMini.WithMini.Mini
{
    ...
    /// </summary>
    public class SpawnerSimpleMini: ISimpleMiniMvcs
    {
        ...
        //  Initialization  -------------------------------
        public SpawnerSimpleMini(IContext context, LeftView leftView, RightView rightViewPrefab)
        {
            _leftView = leftView;
